...
public class Constant {
    ...
    public static class MobileReplenishmentTestDate {
        public static final String MOBILE_PAYMENT_PONE_NUMBER = "686979712";
        ...
        public static final String MOBILE_PAYMENT_NAME = "Peter";
        public static final String MOBILE_PAYMENT_LAST_NAME = "Scroggs";
    }
}
